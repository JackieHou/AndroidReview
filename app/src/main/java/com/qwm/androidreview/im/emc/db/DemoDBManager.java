package com.qwm.androidreview.im.emc.db;
...
import com.qwm.androidreview.im.emc.Constant;
...
public class DemoDBManager {
    ...
    private DemoDBManager(){
        dbHelper = DbOpenHelper.getInstance(MyApplication.getIntance().getApplicationContext());
    }
